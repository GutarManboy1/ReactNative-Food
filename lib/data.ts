const dummyData = {
    ...
    customizations: [
        // Toppings
        { name: "Extra Cheese", price: 250, type: "topping" },
        { name: "Jalapeños", price: 200, type: "topping" },
        { name: "Onions", price: 100, type: "topping" },
        { name: "Olives", price: 150, type: "topping" },
        { name: "Mushrooms", price: 180, type: "topping" },
        { name: "Tomatoes", price: 100, type: "topping" },
        { name: "Bacon", price: 300, type: "topping" },
        { name: "Avocado", price: 350, type: "topping" },

        // Sides
        { name: "Coke", price: 300, type: "side" },
        { name: "Fries", price: 350, type: "side" },
        { name: "Garlic Bread", price: 400, type: "side" },
        { name: "Chicken Nuggets", price: 500, type: "side" },
        { name: "Iced Tea", price: 280, type: "side" },
        { name: "Salad", price: 330, type: "side" },
        { name: "Potato Wedges", price: 380, type: "side" },
        { name: "Mozzarella Sticks", price: 450, type: "side" },
        { name: "Sweet Corn", price: 250, type: "side" },
        { name: "Choco Lava Cake", price: 420, type: "side" },
    ],
